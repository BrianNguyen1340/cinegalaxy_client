...
import { useGetMovieTicketsQuery } from '~/services/movieTicket.service'
                ...
                <tr key={index}>
                  ...
                  <td className='px-4 py-2'>
                    <ul>
                      {item.seats.map((seat, index) => (
                        <li key={index}>
                          <span className='capitalize'>{seat.number}</span>
                          <span className='capitalize'>{seat.row}</span>
                        </li>
                      ))}
                    </ul>
                  </td>
                  ...
                  <td>
                    <div className='flex items-center justify-center'>
                      <Link
                        to={`/detail-movie-ticket/${item._id}`}
...
export default ListMovieTicket
